                ...
                <div class="main_acc__body">
                    ...
                    <div class="main_acc__txt">
                        ...
                        <div class="main_acc__right">
                            <p>Мы занимаемся всеми видами брендинга, от разработки логотипа и отдельных элементов айдентики до создания полноценного брендбука компании. <span class="sel sel_w">Мы обладаем актуальной творческой экспертизой</span>, что позволяет сделать образ созданного нами бренда живым и привлекательным для потенциального клиента.</p>
                        </div><!--.main_acc__right-->
                    </div><!--.main_acc__txt-->
